<template>
    <div>
        ...
        <div class="search-form">
            <input type="text" v-model="searchQuery" placeholder="Cari number member">
            <button @click="searchAnggota">Cari</button>
        </div>
        ...
        <table class="table">
            ...
            <tbody>
            <tr v-for="anggota in anggota" :key="anggota.id">
                <td>{{ anggota.nomor }}</td>
                <td>{{ anggota.nama }}</td>
                ...
                <td>
                    <button class="btn btn-primary" @click="editAnggota(anggota)">Ubah</button>
...
export default {
    ...
    methods: {
        search() {
            ...
            axios.get(`http://localhost/buku/selectAnggotaByKode.php?nomor=${number}`)
                .then(response => {
        ...
        getAnggotaList() {
            axios.get('http://localhost/buku/selectAnggota.php')
                .then(response => {
                    this.daftaranggota = response.data;
                })
                .catch(error => {
                    console.log(error);
                });
